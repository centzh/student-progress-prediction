...
def get_dataset_summary():
    ...
    os.chdir(r"C:\Users\vince\Documents\thesis\data\enrolments")
    ...
    os.chdir(r"C:\Users\vince\Documents\thesis\results")
    ...
    for row in df.itertuples():
        ...
        if challenge == "challenge-advanced-2018":
            continue
    ...
    challenges = ["challenge-newbies-2018", "challenge-beginners-2018", "challenge-beginners-blockly-2018", "challenge-intermediate-2018"]
    print(challenge_dict)
    counts = [challenge_dict[challenge] for challenge in challenges]
    plt.bar(challenges, counts)
